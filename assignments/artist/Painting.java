    ...
    */
    ...
    void regenerate() {
        ...
        for (float[][] child : children) {
            generateShapes(child[0], child[1], child[2], 0);
        }
    }

    void generateShapes(float[] corner0, float[] corner1, float[] corner2, int step) {
        ...
        for (float[][] child : children) {
            generateShapes(child[0], child[1], child[2], ++step);
        }
    }
